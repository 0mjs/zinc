...
func TestProxySanitizesBeforeDirector(t *testing.T) {
	app := zinc.New()
	app.Use(ProxyWithConfig(ProxyConfig{Target: "http://upstream.invalid", Director: func(r *http.Request) { r.Header.Set("X-Verified-User", "trusted") }, Transport: roundTripFunc(func(r *http.Request) (*http.Response, error) {
